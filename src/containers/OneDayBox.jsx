...
import AddForm from '../views/AddForm.jsx'; //eslint-disable no-unused-vars
import EditForm from '../views/EditForm.jsx'; //eslint-disable no-unused-vars
/* eslint-enable */
...
class OneDayBox extends Component {
    ...
    render() {
        ...
        if (this.props.showAddEditForm) {
            entryForm = <AddForm date={this.props.date} submit={this.handleAdd} clear={this.clearForm} />;
...
const mapStateToProps = function mapStateToProps(_store) {
    let state = _store.postState;
    return {
        entrys: state.posts,
