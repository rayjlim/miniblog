...
class UploadViewerController extends Component {
    ...
    render() {
        ...
        let imgUrl = `../uploads/${this.props.filePath}${this.props.fileName}?${this.props.random}`;
        return (
            <div>
                ...
                <AddForm date={this.props.date} submit={this.handleAdd}
                    clear={this.clearForm} showDateModBtns={true} />
                <br />
                <br />
                <br />
                <br />
