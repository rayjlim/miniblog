    ...
    render() {
        return (
            <div className="text-center">
                <button onClick={this.props.handleButtonDirection} className="btn btn-info btn-lrg" value="-1">
                    &lt;&lt;-Prev
                </button>
                <button onClick={this.props.handleButtonDirection} className="btn btn-success btn-lrg" value="1">
                    Next-&gt;&gt;
                </button>
